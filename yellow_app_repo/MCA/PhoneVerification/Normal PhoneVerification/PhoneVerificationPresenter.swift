...
class PhoneVerificationPresenterImplementation: PhoneVerificationPresenterProtocol {

    var phoneVerificationViewController: PhoneVerificationViewController
    
    required init(viewController: PhoneVerificationViewController){
...
//            phoneVerificationViewController.s
            ...
            AppManager.shared.showOkAlert(title: "Alert", message: "Please enter a valid Phone Number.", view: self.phoneVerificationViewController, onCompletion: {(callBackString: String) in })
        }
    }
